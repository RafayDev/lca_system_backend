...
export const createAttendee = async (req, res) => {
    ...
    try {
        const newAttendee = new Attendee({ name, email, phone, city, qualification, seminar_id });
...
export const updateAttendee = async (req, res) => {
    ...
    const { name, email, phone, city, qualification, seminar_id } = req.body;
    try {
        await Attendee.findByIdAndUpdate(id, { name, email, phone, city, qualification, seminar_id });
